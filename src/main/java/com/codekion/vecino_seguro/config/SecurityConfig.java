...
import com.codekion.vecino_seguro.config.filter.JwtAuthenticationFilter;
import com.codekion.vecino_seguro.exception.CustomAccessDeniedHandle;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.
                ...
                .authorizeHttpRequests(authRequest ->
                        authRequest
                                .requestMatchers("/auth/**","/ws/**","/chat/**","/chat","/topic","/ws","/panic-button","/panic-button/**").permitAll()
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:8080", "http://localhost:4200","http://localhost:35966","https://proyect-clever-84ccc.web.app","https://proyect-clever-84ccc.web.app/"));
